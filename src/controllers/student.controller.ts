...
export class StudentController implements IStudentController{
    ...
    async updateStudent(id: string , student: Partial<IStudent>): Promise<IStudentResponse> {
        try{
            const studentUpdated = await this.studentService.updateStudentById(id, student);
